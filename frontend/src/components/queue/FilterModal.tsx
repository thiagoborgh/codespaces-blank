...
const FilterModal: React.FC<FilterModalProps> = ({ 
  ...
  const statusOptions = [
    { id: 'waiting', label: 'Aguardando', color: 'bg-yellow-100 text-yellow-800' },
    { id: 'in_progress', label: 'Em Atendimento', color: 'bg-green-100 text-green-800' },
    { id: 'initial', label: 'Escuta Inicial', color: 'bg-pink-100 text-pink-800' },
    { id: 'completed', label: 'Realizado', color: 'bg-blue-100 text-blue-800' },
    { id: 'cancelled', label: 'Não Aguardou', color: 'bg-gray-200 text-gray-800' }
  ];
